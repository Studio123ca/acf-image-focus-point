(function ($) {
    ...
    var image_focus_point = function ($field) {
        var x,
            y,
            tempX,
            tempY,
            ...
            coordinates,
            // this field's `img`
            $fieldImg = $field.find(".image_focus_point-image img"),
            // this field's marker
            $fieldMarker = $field.find(".image_focus_point-image span"),
            // this field's `input`
            $fieldInput = $field.find("input.image_focus_point-input"),
            ...
            // center button
            $fieldCenterButton = $field.find(".presets .center"),
            ...
            // set up the `image_focus_point` object
            init = function () {
                ...
                $fieldCenterButton.on("click", centerPos);
            },
            ...
            handleClick = function (e) {
                ...
                // transform to percentage base if specified, 2 decimal precision
                if (percentageBased) {
            ...
            setLinkedImg = function () {
                ...
                while (!$imgCon.length) {
                    ...
                    if (!$repeaterParent.length) {
                        console.log(
                            "Couldn't find a match for the linked image"
                        );
                        return false;
                    }
                    ...
                    $repeaterParent = $repeaterParent.parents(
                        ".acf-field-repeater"
                    );
                }
    ...
    if (typeof acf.add_action !== "undefined") {
        ...
        acf.add_action("ready append", function ($el) {
            // search $el for fields of type 'image_focus_point'
            acf.get_fields(
                {
        ...
        // 	$(postbox).find('.field[data-field_type="image_focus_point"]').each(function(){
